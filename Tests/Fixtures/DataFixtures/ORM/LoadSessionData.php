...
use Glavweb\DatagridBundle\Tests\Fixtures\Entity\Session;
...
class LoadSessionData extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        $data = [
            ...
            ['name' => 'Session 3', 'event' => 'event-1', 'reference' => 'session-3'],
            ['name' => 'Session 4', 'event' => 'event-1', 'reference' => 'session-4'],
            ...
            ['name' => 'Session 8', 'event' => 'event-2', 'reference' => 'session-8'],
            ['name' => 'Session 9', 'event' => 'event-2', 'reference' => 'session-9'],
